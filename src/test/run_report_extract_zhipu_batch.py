# -*- coding: utf-8 -*-
# 遍历 data/company_research 下所有 CSV，对 content 列逐行跑智谱 LLM 提取财务预测，结果写入新列。
# 依赖：pip install zai-sdk pandas
...
def call_zhipu(user_message: str, system_instruction: str, api_key: Optional[str] = None) -> str:
...
def process_one_csv(
    ...
    for idx in range(total_reports):
        ...
        for attempt in range(1, MAX_RETRIES + 1):
            try:
                result = call_zhipu(user_text, system_instruction)
